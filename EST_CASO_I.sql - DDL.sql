...
EVENTO_TV INT NOT NULL,
FOREIGN KEY(EVENTO_ATV REFERENCES EVENTOS(ID_EVENTOS));
...
FOREIGN KEY(PA_ATIVIDADEPE_EVENTOPE_EVENTO) REFERENCES ATIVIDADES(ID_ATIVIDADE));